							  ...
							  <!-- Pagination -->
								<div class="pagination">
									<c:if test='${paging.previous != ""}'>
                                    	<a href="/Spacebook/myRentList.do?pageNum=${paging.previous}" class="prevposts-link"><</a>
                                    </c:if>
                                    <c:forEach begin="${paging.startPage}" end="${paging.endPage}" var="i">
                                   		<a href="/Spacebook/myRentList.do?pageNum=${i}" class="current-page">${i}</a>
                                    </c:forEach>
                                    <c:if test='${paging.nextPage != ""}'>
                                    	<a href="/Spacebook/myRentList.do?pageNum=${paging.nextPage}" class="nextposts-link">></a>
                                    </c:if>
                                </div>
								<!-- END Pagination -->
							</div>
